...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 23 15:20:51 2025
...
liste_profile              =[str('A'),str('A2'),str('AB'),str('B2'),str('B2'),str('B'),str('B'),str('C'),str('C'),str('D'),str('D'),str('E'),str('E'),str('F'),str('G'),str('GH'),str('7'),str('2'),str('3'),str('4'),str('4'),str('5'),str('6')]
offline_profile_receivers  =[str('B'),str('B'),str('C'),str('A'),str('C'),str('D'),str('A'),str('AB'),str('E'),str('B'),str('F'),str('C'),str('G'),str('D'),str('E'),str('F'),str('5'),str('4'),str('5'),str('6'),str('2'),str('3'),str('4')]
...
for prof in range (len(liste_profile)):
    ...
    Seis_picks_final_2.to_csv('/home/adelsuc/reveal_projects/HIPER2_FB_TDCORR/flows/Shot_'+liste_profile[prof]+'_OBS_'+offline_profile_receivers[prof]+'/Seis_picks_PhaseNet_s'+liste_profile[prof]+'_o'+offline_profile_receivers[prof]+'_065_MODEL_v1_edge_45_7.5_'+str(freq)+'HZ.csv', index=False,header=True,sep=',')
